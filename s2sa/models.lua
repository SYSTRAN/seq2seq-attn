...
-- pre-allocation of memory for most significant operations
...
function make_decoder_attn(data, opt, simple)
  ...
  local attn = nn.MM():usePrealloc("DEC_CMMS1")({context, nn.Replicate(1,3)(target_t)}) -- batch_l x source_l x 1
  attn = nn.Sum(3)(attn)
